...
# Copied from golden_vest_pet/golden_vest_mac.spec, adapted for MaineCoonDomokun
...
coll = BUNDLE(
    ...
    a.binaries,
    a.datas,
    name='MaineCoonDomokun.app',
    icon='app.icns',              # Generate from icon.png on macOS using sips/iconutil
    bundle_identifier='com.maine-coon.domokun',
    info_plist={
        'CFBundleDisplayName': 'Maine Coon Domokun',
        'CFBundleName': 'MaineCoonDomokun',
        'CFBundleShortVersionString': '1.0',
        'NSHighResolutionCapable': True,
        'LSApplicationCategoryType': 'public.app-category.entertainment',
        'LSMinimumSystemVersion': '11.0',
        'NSRequiresAquaSystemAppearance': False,
        'LSUIElement': True,        # No Dock icon, no Cmd+Tab entry — pet is a floating desktop companion
    },
)
