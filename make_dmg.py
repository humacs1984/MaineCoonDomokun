...
Usage (on macOS):
    python make_dmg.py MaineCoonDomokun.app MaineCoonDomokun.dmg
...
def build_dmg(app_path, output_path, volname="MaineCoonDomokun"):
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python make_dmg.py <MaineCoonDomokun.app> [output.dmg]")
        sys.exit(1)
    app = sys.argv[1]
    output = sys.argv[2] if len(sys.argv) > 2 else "MaineCoonDomokun.dmg"
