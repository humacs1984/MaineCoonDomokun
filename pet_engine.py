#!/usr/bin/env python3
"""
Desktop Pet Hybrid Rendering Engine (Maine Coon Domo-kun v71)
=========================================================
...
# ═══ CONFIG (Maine Coon Domo-kun Pet) ═══
PET_NAME = 'Maine Coon Domo-kun'        # Display name
PET_NAME_ASCII = 'MaineCoonDomokun'       # ASCII name (window title / mutex)
...
class PetWindow(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # backing store still 640×640, cat overflows new 320×320 window for 1 frame).
...
def _find_existing_window():
    ...
    (Old version EXE window title was set by PyInstaller from EXE name "Maine Coon Domo-kun Desktop Pet vN")"""
    import ctypes
